...
// ==========================================
// FLAT USER PROCEDURES (Better-T-Stack)
// ==========================================
...
export const userMe = protectedProcedure.handler(async ({ context }) => {
  const { user } = context;
...
// Change password
export const userChangePassword = protectedProcedure
...
export const userResetPassword = adminProcedure
...
// Bulk user actions
export const userBulkAction = adminProcedure
...
// Get user statistics
export const userStats = adminProcedure.handler(async ({ context }) => {
  const { db } = context;
